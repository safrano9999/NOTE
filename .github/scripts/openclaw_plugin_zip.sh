...
case "$repo" in
  ...
  KACHELMANN|KACHELMANN-MCP-ONLY) files=(README.md KACHELMANN_SOT.md OPENCLAW.md COACHING_ADVISES prompt.md mcp_server.py config.json openclaw.plugin.json package.json requirements.txt index.js scripts systemd kachelmann static templates webui.py) ;;
